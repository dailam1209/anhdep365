...
export default function Sample() {
  ...
  const listIterm3 = [
    {
      key: 1,
      children: <ItemSampleFlow index={0} image={"/home/project_img.png"} text={"Doc"}/>
    },
    {
      key: 2,
  ...
  const listItem4 = [
    {
      key: 1,
      children: () => 
          <ItemSampleFlow index={0} image={"/home/project_img.png"} text={"Doc"}/>
    },
    {
      key: 2,
      children: () => 
  ...
  console.log('isTabnetCheck', isTabnetCheck, isTabSide);
  return (
    <div ref={boxRightRef} style={{ width: `${isTabSide ? `calc(100% - 165px)` : '100%'}`, padding : `${isTabSide ? `0` : '0 5.19rem'}`, paddingTop: "1rem", marginLeft: !isTabSide ?   "" :  "331px"  }} className={`${styles.animation_box} ${!isTabSide ? styleSlide.hidden_sidebar : ''}`}>
      <div
        style={{
      ...
      >
        <div style={{
          ...
          <Slide  number={4} space={20} item={listItem1} className={""} isTitle={false} title={""} />
        </div>
        <Banner/>
        ...
        <ul ref={tabBlockRef} onScroll={handleScroll}>
          ...
          <div style={{width:`${dimensionOfSelected?.width}px`,left:`${dimensionOfSelected?.left}px`}} className={`${stylesProject.selected}`}></div>
        </ul>
        {
          distanceScroll > 0 &&
          <div onClick={handleScrollLeft} className={`${stylesProject.scrollLeft}`}><Image src={'/header/dropdown_icon.png'} width={13} height={6} alt=""></Image></div>
        }
        {
          ...
          <div onClick={handleScrollRight} className={`${stylesProject.scrollRight}`}><Image src={'/header/dropdown_icon.png'} width={13} height={6} alt=""></Image></div>
        }
      </div>
      {/* list follow name */}
      <div style={{
        margin: `2.5rem 0`
           ...
           <Slide number={0} space={20} item={listItem4} className={""} isTitle={true} title={""}/>
      </div>
        <Slide number={3} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={4} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={5} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={6} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={7} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={8} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={9} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={10} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
        <Slide number={11} space={13.75} item={listItem3} className={`${styleSlide.slide_margin_bottom}`} isTitle={true} title={"Có thể bạn sẽ thích"}/>
